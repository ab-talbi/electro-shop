<footer style="background:#f39c12;padding-top:120px" class=" mt-100 footer-eara">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
                <aside class="ab_width">
                    ...
                    <ul>
                        ...
                        <li>Fax: 0512345678</li>
                        <li>email: contact@electro.chop.com</li>
                    </ul>
                </aside>
            </div>
            <div class="col-lg-3 ">
                <aside class="social_width">
                    <div class="f_title">
